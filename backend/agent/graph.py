...
_SYSTEM_TEMPLATE = (
    ...
    "• Keep your answer SHORT: 1-2 sentences maximum.\n"
    "• Example: 'Here are the most relevant papers that built on this work, listed on the right.'\n"
    "• DO NOT list paper titles, authors, years, or any paper details in your prose.\n"
    "• DO NOT write [Link](...) markdown or URLs — the UI cards handle all paper details.\n"
    "• The cards will show: title, authors, year, verification badge, and clickable DOI link.\n"
    "• Your job is ONLY to provide a brief pointer + context, NOT to enumerate papers.\n\n"
    "Tool usage:\n"
